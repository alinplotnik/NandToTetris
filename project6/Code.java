public class Code {
   /**  private String dest;
    private String comp;
    private String jump; */
    // Converts dest instruction to binary representation
    public String dest(String destInstruction) {
        if (destInstruction == null) return "000";
        ...
        switch(destInstruction) {
            ...
            case "ADM": return "111";
            case "AMD": return "111";
            default: throw new IllegalArgumentException("Invalid dest instruction");
        }
    }

    // Converts comp instruction to binary representation
    public String comp(String compInstruction) {
        switch(compInstruction) {
            ...
            default: throw new IllegalArgumentException("Invalid comp instruction");
        }
    }

    // Converts jump instruction to binary representation
    public String jump(String jumpInstruction) {
        if (jumpInstruction == null) return "000";
        ...
        switch(jumpInstruction) {
            ...
            case "JLE": return "110";
            case "JMP": return "111";
            default: throw new IllegalArgumentException("Invalid jump instruction");
        }
    }
}